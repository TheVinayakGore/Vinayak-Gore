...
const Footer = () => {
  ...
  return (
    <>
      <footer className="flex flex-col items-center p-4 md:p-10 space-y-10 md:space-y-28 bg-zinc-100 dark:bg-zinc-950 border-t border-zinc-300 dark:border-zinc-800 text-xs md:text-sm z-40 w-full">
