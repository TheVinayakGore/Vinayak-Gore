...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  useEffect(() => {
    if (ref.current) {
      const updateHeight = () => {
        ...
        const manualHeight = 2000; // Example: Set your manual height here
  ...
  return (
    <div className="flex flex-col items-center justify-center m-auto w-full font-sans" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8 w-full">
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col sm:flex-row z-40 items-center top-40 self-start w-[40%] sm:w-1/2">
              ...
              <h3 className="text-xl text-start sm:text-2xl md:pl-20 md:text-5xl font-bold bg-gradient-to-b from-black to-zinc-400 dark:from-zinc-300 dark:to-zinc-600 bg-clip-text tracking-tight text-transparent py-5">
                {item.title}
              </h3>
            </div>
